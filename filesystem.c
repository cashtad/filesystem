...
int main(const int argc, char *argv[]) {
    ...
    while (true) {
        ...
        switch (command_code) {
            ...
            case copy_code:
                printf(PROCESSING_COMMAND copy "\n");
                break;
            case move_code:
                printf(PROCESSING_COMMAND move "\n");
                break;

            case remove_code:
                printf(PROCESSING_COMMAND remove "\n");
                break;

            case make_directory_code:
                printf(PROCESSING_COMMAND make_directory "\n");
                break;

            case remove_directory_code:
                printf(PROCESSING_COMMAND remove_directory "\n");
                break;

            case list_contents_code:
                printf(PROCESSING_COMMAND list_contents "\n");
                break;

            case contains_at_code:
                printf(PROCESSING_COMMAND contains_at "\n");
                break;

            case change_directory_code:
                printf(PROCESSING_COMMAND change_directory "\n");
                break;

            case path_code:
                printf(PROCESSING_COMMAND path "\n");
                break;

            case info_code:
                printf(PROCESSING_COMMAND info "\n");
                break;

            case move_into_filesystem_code:
                printf(PROCESSING_COMMAND move_into_filesystem "\n");
                break;

            case move_out_of_filesystem_code:
                printf(PROCESSING_COMMAND move_out_of_filesystem "\n");
                break;

            case load_script_code:
                printf(PROCESSING_COMMAND load_script "\n");
                break;

            case format_code:
                printf(PROCESSING_COMMAND format "\n");
                break;

            case exit_manual_code:
                printf(PROCESSING_COMMAND exit_manual "\n");
                return(0);
